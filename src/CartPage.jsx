...
const CartPage = () => {
  ...
  useEffect(() => {
    const fetchCartItems = async () => {
      try {
        const response = await fetch("https://salessavvy-backend-u6z1.onrender.com/api/cart/items", {
  ...
  const handleRemoveItem = async (productId) => {
    try {
      const response = await fetch("https://salessavvy-backend-u6z1.onrender.com/api/cart/delete", {
        method: "DELETE",
  ...
  const handleQuantityChange = async (productId, newQuantity) => {
    try {
      ...
      const response = await fetch("https://salessavvy-backend-u6z1.onrender.com/api/cart/update", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
  ...
  const handleCheckout = async () => {
    try {
      ...
      const response = await fetch("https://salessavvy-backend-u6z1.onrender.com/api/payment/create", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        credentials: "include",
      ...
      const options = {
        ...
        handler: async function (response) {
          try {
            ...
            const verifyResponse = await fetch("https://salessavvy-backend-u6z1.onrender.com/api/payment/verify", {
              method: "POST",
              headers: { "Content-Type": "application/json" },
              credentials: "include",
              body: JSON.stringify({
